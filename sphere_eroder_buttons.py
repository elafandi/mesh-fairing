...
P = np.genfromtxt('meshes/p_sphere_480_bumpy.txt', delimiter=',')
T = np.genfromtxt('meshes/t_sphere_480_bumpy.txt', delimiter=',', dtype=int)
...
surf = ax.plot_trisurf(P[:,0], P[:,1], T, P[:,2], edgecolor='k', linewidth=1.0, shade=False)
